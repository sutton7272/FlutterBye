...
import { EarlyAccessGateway } from "@/components/early-access-gateway";
...
const AdminEarlyAccessManagement = lazy(() => import("@/pages/admin-early-access-management"));
